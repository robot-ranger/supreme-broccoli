...
class ConditionLevel(Enum):
    ...
    NORMAL = auto()  # Normal: condition state that indicates operation within specified limits.
    WARNING = auto()  # Warning: condition state that requires concern and supervision and may become hazardou...
    FAULT = auto()  # Fault: condition state that requires intervention to continue operation to function ...
